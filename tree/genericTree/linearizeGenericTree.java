/*
     ...
     steps-:
     1) traverse from last-   ie size-2
     2) get the last node 
     3)get the second last node
     4) remove the last node (store it somewhere)
     5)get the tail of the second last and attach it with the last stored value
