  /*
  Symmetric means if we cut the tree in half, if both left side and right sides
  look similar then it is symmetric tree

  solution --->> if the tree is mirror tree , then it is symmetric
